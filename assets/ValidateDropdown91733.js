...
`)},Lt={root:function(t){var a=t.props;return["p-tabs p-component",{"p-tabs-scrollable":a.scrollable}]}},St=g.extend({name:"tabs",theme:Ct,classes:Lt}),Pt={name:"BaseTabs",extends:m,props:{value:{type:[String,Number],default:void 0},lazy:{type:Boolean,default:!1},scrollable:{type:Boolean,default:!1},showNavigators:{type:Boolean,default:!0},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1}},style:St,provide:function(){return{$pcTabs:this,$parentInstance:this}}},At={name:"Tabs",extends:Pt,inheritAttrs:!1,emits:["update:value"],data:function(){return{id:this.$attrs.id,d_value:this.value}},watch:{"$attrs.id":function(t){this.id=t||V()},value:function(t){this.d_value=t}},mounted:function(){this.id=this.id||V()},methods:{updateValue:function(t){this.d_value!==t&&(this.d_value=t,this.$emit("update:value",t))},isVertical:function(){return this.orientation==="vertical"}}};function Nt(e,t,a,s,o,n){return l(),u("div",r({class:e.cx("root")},e.ptmi("root")),[d(e.$slots,"default")],16)}At.render=Nt;const Vt={class:"flex flex-col gap-1"},It=["for"],Kt={class:"padding-detail"},zt=U({__name:"ValidateDropdown",props:{id:{},name:{},label:{},disabled:{type:Boolean},options:{},optionLabel:{type:[String,Function]},optionValue:{type:[String,Function]},detailMode:{type:Boolean},showClear:{type:Boolean}},setup(e){const t=e,a=j(),s=q(()=>a.value&&a.value.label!=="p-emptylabel"?a.value.label:null),{value:o,errorMessage:n}=J(()=>t.name?t.name:"");return(i,c)=>{const p=tt,$=et;return l(),u("div",Vt,[b("label",{class:"form-label",for:i.id},C(i.label),9,It),v(b("div",null,[Y(p,{modelValue:h(o),"onUpdate:modelValue":c[0]||(c[0]=y=>Z(o)?o.value=y:null),ref_key:"selectRef",ref:a,"input-id":i.id,disabled:i.disabled,options:i.options,"option-label":i.optionLabel,"option-value":i.optionValue,showClear:i.showClear,invalid:!!h(n)},null,8,["modelValue","input-id","disabled","options","option-label","option-value","showClear","invalid"]),h(n)?(l(),f($,{key:0,severity:"error",size:"small",variant:"simple"},{default:P(()=>[G(C(h(n)),1)]),_:1})):k("",!0)],512),[[S,!i.detailMode]]),v(b("div",null,[d(i.$slots,"detail",{data:{label:s.value,field:h(o)}},()=>[b("p",Kt,C(s.value??""),1)],!0)],512),[[S,i.detailMode]])])}}}),_t=Q(zt,[["__scopeId","data-v-7c14da7b"]]);export{_t as V,At as a,ot as b,dt as c,$t as d,kt as e,E as s};
